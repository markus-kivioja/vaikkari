...
#include "../../jukan_koodit/Types/Buffer.hpp"
...
public:
	...
	ddouble getMinR() const { return m_rplug; }
	ddouble getMaxR() const { return m_rplug + m_rsize * m_rstep; }
	ddouble getMaxZ() const { return m_zsize * m_zstep; }
	...
	ddouble integrateZ(const ddouble vol) const; // returns Z, which satisfies equation \int_{z<Z} |\Psi|^2 == vol
